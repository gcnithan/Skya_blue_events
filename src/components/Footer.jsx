...
//                 <li>Email: info@skyblueeventmanagement.in</li>
//                 <li>Phone: +91 9353168582</li>
//                 <li>
//                   Address: No.17/4, 2nd Floor, Veerashaiva Lingayat Bhavan,
//                   Sadashiva Nagar, Armane Nagar, Bengaluru, Karnataka 560080
//                 </li>
//               </ul>
//             </div>
//           </div>
...
//                   © 2025 SkyBlue Event Management India Pvt. Ltd. <br></br>All
//                   rights reserved.
//                 </p>
//               </div>
...
//                     className="group relative w-10 h-10 flex items-center justify-center rounded-full bg-white border border-gray-200 hover:border-gray-300 hover:shadow-md hover:scale-110 transition-all duration-300"
...
const Footer = () => {
  ...
  return (
    <footer
      ref={footerRef}
      className="w-full bg-linear-to-br from-gray-50 via-white to-gray-50 border-t border-gray-200"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <motion.div
