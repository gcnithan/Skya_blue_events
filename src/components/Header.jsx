...
const Header = () => {
  ...
  return (
    <>
      <header
        className={`fixed inset-x-0 top-0 z-50 py-4 lg:py-5 transition-all duration-300 ${
          isSticky
        ...
        <div className="px-6 mx-auto sm:px-8 lg:px-12 max-w-7xl">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              aria-label="Home"
            >
              <img src="assets/Skyblue.png" alt="Logo" className="h-20 w-auto" />
            </button>
